...
class TestPositive: #pytest -v ./test_positive.py::TestPositive::test_step1
    ...
    def test_step2(self, make_files):
        # test2
        res1 = ssh_checkout("0.0.0.0", "user2", "2222",
                            "cd {}; 7z e arx2.7z -o{} -y".format(data["folder_out"], data["folder_ext"]), "Everything "
                                                                                                          "is Ok")
        res2 = ssh_checkout("0.0.0.0", "user2", "2222",
    ...
    def test_step4(self):
        # test4
        assert ssh_checkout("0.0.0.0", "user2", "2222",
                            "cd {}; 7z u {}/arx2.7z".format(data["folder_in"], data["folder_out"]), "Everything is Ok"), "test4 FAIL"
